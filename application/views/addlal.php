...
<form action="<?php echo base_url('index.php/AddLectures/submit') ?>" method="post" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            ...
            <input type="number" name="num_con" class="form-control">
        </div>
    </div>
    ...
    <div class="form-group">
        <label for="exampleInputPassword1" class="col-md-2 text-right">Password</label>
        <div class="col-md-10">
    ...
    <div class="form-group">
        <label for="exampleInputPassword1" class="col-md-2 text-right">Password Again</label>
        <div class="col-md-10">
