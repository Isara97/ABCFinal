...
<div class="mainDiv">
    ...
    <div class="container">
        <nav>
			<h1 class="brand"><a href="<?php echo base_url('LmsController/home'); ?>">A<span>BC</span> Institute </a><span> Student Home</span></h1>
    ...
    <div class="profileBox">
        ...
        <div class="user-setting">
            ...
            <br><br><br><br>
            <h1 style="color: #2471A3;">Hi <?php if (isset($_SESSION['userFirst'])){ echo $_SESSION['userFirst'];} ?>!!!</h1>
            <!--<h1>Welcome Back</h1>-->
        </div>
    </div>
